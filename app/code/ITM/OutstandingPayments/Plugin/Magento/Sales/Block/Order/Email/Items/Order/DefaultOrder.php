...
namespace ITM\OutstandingPayments\Plugin\Magento\Sales\Block\Order\Email\Items\Order;
...
class DefaultOrder
{
    ...
    public function afterGetItemOptions(
        ...
        $docEntry = "";
        $docType = "";
        $company = $this->helper->getCustomerSapCompany($subject->getOrder()->getCustomerId());
