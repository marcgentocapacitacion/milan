...
namespace ITM\Pricing\Block\Adminhtml\Groupdiscount\Edit\Tab;
...
class Main extends Generic implements TabInterface
{
    ...
    {
        $model = $this->_coreRegistry->registry('current_itm_pricing_groupdiscount');
        ...
        $fieldset->addField(
            'attribute_code',
            'text',
            ['name' => 'attribute_code', 'label' => __('Attribute Code'), 'title' => __('Attribute Code'), 'required' => true]
        );
        $fieldset->addField(
            'attribute_value',
            'text',
            ['name' => 'attribute_value', 'label' => __('Attribute Value'), 'title' => __('Attribute Value'), 'required' => true]
        );
        $fieldset->addField(
            'start_date',
            'date',
