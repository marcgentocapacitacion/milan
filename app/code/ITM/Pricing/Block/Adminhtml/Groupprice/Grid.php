<?php
namespace ITM\Pricing\Block\Adminhtml\Groupprice;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \ITM\Pricing\Model\ResourceModel\Groupprice\CollectionFactory $collectionFactory,
        //\ITM\Pricing\Model\ResourceModel\Groupprice\Collection $collectionFactory,
    ...
    public function getMainButtonsHtml()
    {
        ...
        ->setData(array(
            ...
            'onclick'   => "setLocation('".$this->getUrl('*/system/refreshcache',["model"=>"groupprice"])."')",
        ...
        $addButton = $this->getLayout()->createBlock('Magento\Backend\Block\Widget\Button')
        ->setData(array(
            'label'     => __("Index Group Tables"),
            'onclick'   => "setLocation('".$this->getUrl('*/system/indexgrouptables',["model"=>"groupprice"])."')",
            'class'   => 'action-default scalable action-reset action-tertiary'
        ))->toHtml();
        $html .= $addButton;
