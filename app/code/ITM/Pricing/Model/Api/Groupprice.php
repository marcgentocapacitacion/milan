...
use ITM\Pricing\Api\GrouppriceInterface;
use Magento\Framework\Setup\ModuleDataSetupInterface;

class Groupprice implements GrouppriceInterface
{
    ...
    {
        $collection = $this->_objectManager->create('\ITM\Pricing\Model\ResourceModel\Groupprice\Collection');
