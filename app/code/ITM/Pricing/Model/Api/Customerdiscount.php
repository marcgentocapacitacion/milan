...
use ITM\Pricing\Api\CustomerdiscountInterface;
use Magento\Framework\Setup\ModuleDataSetupInterface;

class Customerdiscount implements CustomerdiscountInterface
{
    ...
    {
        $collection = $this->_objectManager->create('\ITM\Pricing\Model\ResourceModel\Customerdiscount\Collection');
