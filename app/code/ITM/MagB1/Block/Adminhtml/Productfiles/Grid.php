...
namespace ITM\MagB1\Block\Adminhtml\Productfiles;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \ITM\MagB1\Model\ResourceModel\Productfiles\CollectionFactory $collectionFactory,
        Status $status,
        array $data = []
    ) {
