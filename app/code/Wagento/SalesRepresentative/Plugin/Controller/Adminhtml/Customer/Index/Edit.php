...
namespace Wagento\SalesRepresentative\Plugin\Controller\Adminhtml\Customer\Index;
...
class Edit
{
    ...
    public function aroundExecute(
        ...
        if (! $this->salesRepresentativeHelper->isCustomerEditAllowed($customerId)) {
            // add error message
            $this->messageManager->addErrorMessage(__('You do not have permission to edit this customer.'));

            // set url to redirect
            $resultRedirect = $this->resultFactory->create(
                ResultFactory::TYPE_REDIRECT
            );
            $url = $this->_backendUrl->getUrl("customer/index");
