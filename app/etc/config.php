...
return [
    'modules' => [
        ...
        'WeltPixel_Backend' => 1,
        'Wagento_LiveSearchAdapter' => 0,
        'Wagento_LiveSearchStorefrontPopover' => 0,
